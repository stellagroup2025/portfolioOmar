...
export function Contact() {
  ...
  const handleCopy = (e: React.SyntheticEvent) => {
    e.preventDefault();
    navigator.clipboard.writeText("osomoza@avanzadi.com");
    setCopied(true);
    ...
    <div className="w-full h-dvh bg-[#faf9f6] flex flex-col items-center justify-center relative overflow-hidden px-6 md:px-12">
      <div className="w-full max-w-5xl z-20 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col items-center mb-16 md:mb-24">
          ...
          >
            Los caminos se reconocen
            <br className="hidden md:block" /> cuando llega el momento.
          </h2>
        ...
        <div className="flex flex-col items-center gap-12 md:gap-16">
          ...
          <div className="relative group flex flex-col items-center">
            <a
              href={isMobile ? undefined : "mailto:osomoza@avanzadi.com"}
              onClick={(e) => {
                if (isMobile) {
                  e.preventDefault();
                  handleCopy(e);
              ...
              <AnimatePresence mode="wait">
                {copied ? (
                  <motion.span
                    ...
                    className={cn(
                      "text-xs md:text-sm text-green-600 font-medium tracking-wide",
                      spaceMono.className,
                    )}
                  >
                    COPIADO
